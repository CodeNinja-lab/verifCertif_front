...
const conversations = [
  ...
  },
  {
    id: 3,
    company: "DataSystems",
    recruiter: "Marie Leroy",
    avatar: "/placeholder.svg?height=40&width=40",
    lastMessage: "Votre profil nous intéresse beaucoup",
    time: "Hier",
    unread: 1,
    online: true,
  },
...
const messages = [
  {
    id: 1,
    sender: "recruiter",
    content: "Bonjour, votre profil correspond parfaitement à notre recherche !",
    time: "10:30",
  },
  {
    id: 2,
  ...
  },
  {
    id: 5,
    sender: "recruiter",
    content: "Parfait ! Je vous propose jeudi à 15h en visioconférence. Je vous envoie le lien.",
    time: "10:40",
  },
]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Échangez avec les recruteurs</p>
      </div>
            ...
            <div className="space-y-1 p-2">
              {conversations.map((conv) => (
                ...
                >
                  <div className="relative">
                    <Avatar>
                      <AvatarImage src={conv.avatar || "/placeholder.svg"} alt={conv.recruiter} />
                      <AvatarFallback>{conv.recruiter.substring(0, 2)}</AvatarFallback>
                    </Avatar>
                    {conv.online && (
                  ...
                  <div className="flex-1 overflow-hidden">
                    <div className="flex items-center justify-between">
                      <div className="font-semibold text-sm">{conv.company}</div>
                      {conv.unread > 0 && (
              ...
              <div className="relative">
                <Avatar>
                  <AvatarImage
                    ...
                    alt={selectedConversation.recruiter}
                  />
                  <AvatarFallback>{selectedConversation.recruiter.substring(0, 2)}</AvatarFallback>
                </Avatar>
